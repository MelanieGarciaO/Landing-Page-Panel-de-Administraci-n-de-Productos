...
SECRET_KEY = 'django-insecure-h0&@ab&)_gu0!@wtn@cixjpp=#7lefn3kz&ely^-3aqt4cn1pp'
...
print(f">>> PRODUCT_VARIANT={PRODUCT_VARIANT}  ENABLE_REPORTS={ENABLE_REPORTS}  ENABLE_NOTIFICATIONS={ENABLE_NOTIFICATIONS}")
